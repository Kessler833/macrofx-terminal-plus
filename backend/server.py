...
last_state:   dict = {}
trend_overrides: dict = {}      # updated by AV fetcher
...
async def startup():
    # First fast fetch (FX rates only, no blocking)
...
async def update_config(body: ConfigUpdate):
    ...
    cfg_save(cfg)
    # Re-create fetcher with new keys
    fetcher.cfg = cfg
